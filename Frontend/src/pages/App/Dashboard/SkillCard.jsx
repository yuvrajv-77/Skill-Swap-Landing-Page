...
function SkillCard({ data }) {
    ...
    return (
        <div className='max-w-[36rem]  gap-x-6 cursor-pointer rounded-2xl flex p-5 shadow-lg bg-white'>
            ...
            <div className='flex flex-col gap-y-2'>
                ...
                <div className='flex gap-2'>
                    <Button variant='gradient' onClick={accessChat} size='sm' className='text-[12px] font-normal font-poppins px-2 py-1 flex items-center gap-1 capitalize '>
